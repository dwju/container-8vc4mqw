...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-8vc4mqw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-8vc4mqw.containers.anotherwebservice.com/
...
```
git clone git@github.com:dwju/container-8vc4mqw.git
cd container-8vc4mqw
```
...
```
docker attach container-8vc4mqw
```
